...
struct Fast_In
{
    ...
    _force_inline Fast_In& operator>>(int& x)
    {
    ...
    _force_inline Fast_In& operator>>(long long& x)
    {
        _fast_read_integer(x);
        return *this;
    }
...
struct Fast_Out
{
    ...
    _force_inline Fast_Out& operator<<(const int& x)
    {
        _fast_print_integer(x);
        return *this;
    }   
        
    _force_inline Fast_Out& operator<<(const unsigned int& x)
    {
        _fast_print_integer(x);
        return *this;
    }   

    _force_inline Fast_Out& operator<<(const long long& x)
    {
        _fast_print_integer(x);
        return *this;
    }
    
    _force_inline Fast_Out& operator<<(const unsigned long long& x)
    {
        _fast_print_integer(x);
        return *this;
    }
